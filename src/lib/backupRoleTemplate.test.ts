...
describe('backup role SQL template', () => {
  it('is rerunnable and grants read access without the predefined write role', () => {
    ...
    expect(BACKUP_ROLE_SQL).toContain('REVOKE pg_write_all_data FROM vaultbase_backup')
